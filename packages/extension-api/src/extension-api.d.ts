...
declare module '@podman-desktop/api' {
  ...
  export namespace env {
    ...
    /**
     * Flag indicating whether we are running on a FreeBSD operating system.
     *
     * If the value of this flag is true, it means the current system is FreeBSD.
     * If the value is false, it means the current system is not FreeBSD.
     */
